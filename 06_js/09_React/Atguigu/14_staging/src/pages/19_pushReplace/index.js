        ...
        <div className="row">
          <div className='col-xs-2 col-xs-offset-2'>
            <div className='list-group'>
              ...
              <MyNavLink to="/19/about" title="About" ></MyNavLink>
              <MyNavLink to="/19/home" title="Home" ></MyNavLink>
            </div>
          </div>
          <div className='col-xs-6'>
            <div className='panel'>
              <div className='panel-body'>
                ...
                <Switch>
                  <Route path='/19/about' component={About} />
                  <Route path='/19/home' component={Home} />
                  <Redirect to="/19/home"/>
                </Switch>
              </div>
            </div>
