...
public class CarInfoExcelReader {
     ...
     */
    public static Map<String, List<Map<String, Object>>> readCarInfoExcel() {
        // 创建监听器
        CarInfoSheetListener listener = new CarInfoSheetListener();
    ...
    public static void main(String[] args) {
        try {
            Map<String, List<Map<String, Object>>> carDataMap = readCarInfoExcel();

            // 遍历输出各Sheet信息
            for (Map.Entry<String, List<Map<String, Object>>> entry : carDataMap.entrySet()) {
