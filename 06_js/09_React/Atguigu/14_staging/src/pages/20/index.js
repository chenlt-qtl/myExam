        ...
        <div className="row">
          <div className='col-xs-2 col-xs-offset-2'>
            <div className='list-group'>
              ...
              <MyNavLink to="/20/about" title="About" ></MyNavLink>
              <MyNavLink to="/20/home" title="Home" ></MyNavLink>
            </div>
          </div>
          <div className='col-xs-6'>
            <div className='panel'>
              <div className='panel-body'>
                ...
                <Switch>
                  <Route path='/20/about' component={About} />
                  <Route path='/20/home' component={Home} />
                </Switch>
              </div>
            </div>
          </div>
