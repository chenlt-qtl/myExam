        ...
        <div className="row">
          <div className='col-xs-2 col-xs-offset-2'>
            <div className='list-group'>
              ...
              <MyNavLink to="/21/about" title="About" ></MyNavLink>
              <MyNavLink to="/21/home" title="Home" ></MyNavLink>
            </div>
          </div>
          <div className='col-xs-6'>
            <div className='panel'>
              <div className='panel-body'>
                ...
                <Switch>
                  <Route path='/21/about' component={About} />
                  <Route path='/21/home' component={Home} />
                </Switch>
              </div>
            </div>
          </div>
